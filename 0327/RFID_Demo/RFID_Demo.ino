...
#define txPin      10  // Serial output (unused)
...
void loop()  // Main code, to run repeatedly
{
  ...
  */   
  ...
  Serial.print("Get Card#");       // The rfidData string should now contain the tag's unique ID with a null termination, so display it on the Serial Monitor
